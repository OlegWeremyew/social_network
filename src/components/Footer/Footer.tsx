...
export const Footer: FC = () => (
  <div className={style.footer}>
    <div className={style.copyright__text}>
      ...
      <div>
        Made with <span className={style.copyright__header}>&#10084;</span>{' '}
        <span>by Oleg Veremyev</span>
      </div>

      <div className={style.phoneBlock}>
        <div className={style.phone}>
          <img src={operatorMts} alt="operator mts" />
          <a href="tel:+375298413953">+375 (29) 841-39-53</a>
        </div>

        <div className={style.phone}>
          <img src={phone} alt="phone" />
          <a href="tel:+375173582979">+375 (17) 358-29-79</a>
        </div>
