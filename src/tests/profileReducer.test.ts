...
test("length message should been increment", () => {
    ...
    let newState = profileReducer(initialState, ProfileActions.addPost(postMessage))
...
test("after delete length should be decrement", () => {
    ...
    let newState = profileReducer(initialState, ProfileActions.deletePost(postNumber))
